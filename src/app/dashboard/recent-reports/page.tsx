  ...
  return (
    <div className="pb-10 animate-in fade-in duration-500">
      <div className="flex items-center gap-4 mb-10 px-2">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">Recent Reports</h1>
      </div>
      ...
      <div className="bg-[#F3F4F6] border border-slate-200 rounded-[2.5rem] p-16 text-center flex flex-col items-center justify-center shadow-sm">
        ...
        <p className="text-slate-500 text-lg mb-8 max-w-md">
          The <strong>Recent Reports</strong> page is currently under development. Downloadable PDFs and historical records.
        </p>
      </div>
    </div>
  );
